...
@NgModule({
  ...
  declarations: [ContradictionIndexComponent, SearchComponent, TheoryComponent, PhysicalComponent, ReverseComponent, ParamsComponent, ContradictionRightBarComponent]
})
